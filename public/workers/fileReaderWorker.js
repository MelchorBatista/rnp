    ...
    reader.onload = function () {
      ...
      if (start >= totalSize) {
        try {
          ...
          if (!data || typeof data !== 'object' || !data.Anio || !data.Mes || !data.CodigoOrganismoMAP) {
            self.postMessage({ error: 'El JSON debe tener los campos Anio, Mes y CodigoOrganismoMAP.' });
            return;
          }
